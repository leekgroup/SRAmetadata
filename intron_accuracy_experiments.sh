...
gzip -cd collected_introns.tsv.gz | pypy asymptote.py --sample-fraction 0.05 --read-min 20 -p 31 >intron_accuracy_sample_fraction_0.05_read_min_20.tsv
gzip -cd collected_introns.tsv.gz | pypy asymptote.py --sample-fraction 0.05 --read-min 25 -p 31 >intron_accuracy_sample_fraction_0.05_read_min_25.tsv