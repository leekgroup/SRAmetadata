...
load("deletions_countmatrix_geuvadis.rda")

ref <- read.delim("../ALL_wgs_phase3_indels_deletions.vcf", 
           header = FALSE, 
...
save(countsMf_ref, file = "deletions_countmatrix_geuvadis_ref.rda")
