...
load('deletions_countmatrix_geuvadis_ref.rda')
...
save(pca, file = "pca_deletions_ref_normalized.rda")
...
CairoPNG(file = "pca_deletions_ref_12.png", 800, 800)
...
CairoPNG(file = "pca_deletions_ref_13.png", 800, 800)
...
CairoPNG(file = "pca_deletions_ref_23.png", 800, 800)
...
CairoPNG(file = "pca_deletions_ref_12_base.png", 800, 800)
...
CairoPNG(file = "pca_deletions_ref_13_base.png", 800, 800)
...
CairoPNG(file = "pca_deletions_ref_23_base.png", 800, 800)
